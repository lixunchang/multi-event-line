...
export var getLineDashYList = function getLineDashYList(count, space) {
  var dashList = [];
...
export var analysisEventData = function analysisEventData(events) {
  ...
  return events.reduce(function (_ref2, event) {
    ...
    return {
      min: Math.min(
        min || parseInt(event === null || event === void 0 ? void 0 : event[eventStart]),
        parseInt(event === null || event === void 0 ? void 0 : event[eventStart]),
      ),
      max: Math.max(
        max || 0,
        parseInt(event === null || event === void 0 ? void 0 : event[eventEnd]),
      ),
    };
  }, {});
...
export var analysisLineData = function analysisLineData(lines) {
  ...
  return lines.reduce(function (_ref4, event) {
    ...
    return {
      minDt: Math.min(
        minDt || parseInt(event === null || event === void 0 ? void 0 : event[lineXField]),
        parseInt(event === null || event === void 0 ? void 0 : event[lineXField]),
      ),
      maxDt: Math.max(
        maxDt || 0,
        parseInt(event === null || event === void 0 ? void 0 : event[lineXField]),
      ...
      minValue: Math.min(
        minValue || (event === null || event === void 0 ? void 0 : event[lineYField]),
        event === null || event === void 0 ? void 0 : event[lineYField],
      ),
      maxValue: Math.max(
        maxValue || 0,
        event === null || event === void 0 ? void 0 : event[lineYField],
